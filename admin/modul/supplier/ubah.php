      ...
      <div class="col-md-6 col-md-offset-3">
        <form action="?m=supplier&s=update" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="namaSupplier" name="nama_sup" value="<?php echo $r['nama_sup']; ?>" placeholder="Masukkan Nama">
          </div>

          <div class="form-group">
            <label for="kontakSupplier">Kontak Supplier</label>
            <input type="text" class="form-control" id="kontakSupplier" name="kontak_sup" value="<?php echo $r['kontak_sup']; ?>" placeholder="Masukkan Kontak">
          </div>

          <div class="form-group">
            <label for="alamatSupplier">Alamat Supplier</label>
            <input type="text" class="form-control" id="alamatSupplier" name="alamat_sup" value="<?php echo $r['alamat_sup']; ?>" placeholder="Masukkan Alamat">
          </div>

          <div class="form-group">
            <label for="teleponSupplier">Telepon Supplier</label>
            <input type="text" class="form-control" id="teleponSupplier" name="telepon_sup" value="<?php echo $r['telepon_sup']; ?>" placeholder="Masukkan Nomor Telepon">
          </div>
